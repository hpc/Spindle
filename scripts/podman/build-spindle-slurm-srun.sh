#!/bin/bash
#
# Build Spindle Slurm srun test container for podman
#
# This builds the Slurm testing image with Spindle.
...
DOCKERFILE="$REPO_ROOT/containers/spindle-slurm-ubuntu/testing-srun/Dockerfile.podman"

echo "=========================================="
echo "Building Spindle Slurm Srun Container"
echo "=========================================="
echo ""
...
cd "$REPO_ROOT/containers/spindle-slurm-ubuntu/testing-srun"
./generate_config.sh
...
echo ""
echo "Next steps:"
echo "  1. Run regular tests: ./scripts/podman/test-spindle-slurm-srun.sh"
echo ""
