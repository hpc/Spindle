...
char* _message_type_to_str (ldcs_message_ids_t type) {
  ...
  return(
    ...
    (type == LDCS_MSG_EXISTS_QUERY) ? "LDCS_MSG_EXISTS_QUERY" :
    (type == LDCS_MSG_STAT_QUERY) ? "LDCS_MSG_STAT_QUERY" :
    (type == LDCS_MSG_STAT_ANSWER) ? "LDCS_MSG_STAT_ANSWER" :
    (type == LDCS_MSG_STAT_NET_REQUEST) ? "LDCS_MSG_STAT_NET_REQUEST" :
    (type == LDCS_MSG_STAT_NET_RESULT) ? "LDCS_MSG_STAT_NET_RESULT" :
    (type == LDCS_MSG_EXISTS_ANSWER) ? "LDCS_MSG_EXISTS_ANSWER" :
